...
<div id="mh-board-write" class="content " class="clearfix">
	...
	<?php if($_REQUEST['edit_type'] == 'guest' && $_REQUEST['action'] == 'delete' && wp_verify_nonce($_REQUEST['_mh_board_nonce'],'mh_board_nonce')):?>
		<div id="popup">
			<form action="/edit" method="post" id="delete_board"><input type="hidden" name="post_id" value="<?php echo $_POST['post_id'];?>"/>
	...
	<form action="" method="post">
		...
		<table cellpadding="0" cellspacing="0">
			...
			<tr>
				<th>태그</th><td><input type="text" name="post_tag" tabindex="3" value="<?php the_tags();?>">*콤마(,)로 구분해주세요.</td>
			</tr>
			<tr>
